    ...
    <div class="super-admin">
      ...
      <table>
        ...
        <tr v-for="(room_book, i) in room_books" :key="i">
          ...
          <td v-if="room_book.orderStatus == 'CONFIRMED'" class="accept">
            Принято
          </td>
          <td v-else-if="room_book.orderStatus == 'PAID'" class="accept">
            Оплачено
          </td>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        "http://localhost:8083/room/order/get-confirmed-or-declined/?page=" +
          page,
        {
          headers: {
